...
- (void)setEmotionType:(EmotionType)emotionType{
    ...
    if (self.emotionType == EmotionTypeGif) {
        self.emotionImageView.frame = CGRectMake(0, 0, kXHGifEmotionImageViewSize, kXHGifEmotionImageViewSize);
    }else{
        self.emotionImageView.frame = CGRectMake(0, 0, kXHImgEmotionImageViewSize, kXHImgEmotionImageViewSize);
    }
}
...
- (void)setup {
    if (!_emotionImageView) {
        UIImageView *emotionImageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, kXHGifEmotionImageViewSize, kXHGifEmotionImageViewSize)];
